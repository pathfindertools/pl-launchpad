...
blocks:
  ...
  - style:
    ...
    body: >
      ...
      Network](https://protocol.ai/work/), IPFS, [libp2p](https://libp2p.io/),
      [IPLD](https://ipld.io/), Filecoin, and the variety of tools & SDKs that
      are used across the web3 universe.
    _template: feature
  - style:
      textAlignment: text-left
      minHeight: min-h-0
